...
namespace EyeLookEditor
{
    ...
    public class EyeLookEditor : BaseUnityPlugin
    {
        ...
        private void RegisterCustomSubCategories(object sender, RegisterSubCategoriesEvent e)
        {
            ...
            var slider_thresholdAngleDifference = e.AddControl(new MakerSlider(category, "thresholdAngleDifference", -360f, 360f, DefaultValue.ThresholdAngleDifference, this) { StringToValue = stringToValue, ValueToString = valueToString });
            var slider_bendingMultiplier = e.AddControl(new MakerSlider(category, "bendingMultiplier", -100f, 100f, DefaultValue.BendingMultiplier, this) { StringToValue = stringToValue, ValueToString = valueToString });
            var slider_maxAngleDifference = e.AddControl(new MakerSlider(category, "maxAngleDifference", -360f, 360f, DefaultValue.MaxAngleDifference, this) { StringToValue = stringToValue, ValueToString = valueToString });
            var slider_upBendingAngle = e.AddControl(new MakerSlider(category, "upBendingAngle", -360f, 360f, DefaultValue.UpBendingAngle, this) { StringToValue = stringToValue, ValueToString = valueToString });
            var slider_downBendingAngle = e.AddControl(new MakerSlider(category, "downBendingAngle", -360f, 360f, DefaultValue.DownBendingAngle, this) { StringToValue = stringToValue, ValueToString = valueToString });
            var slider_minBendingAngle = e.AddControl(new MakerSlider(category, "minBendingAngle", -360f, 360f, DefaultValue.MinBendingAngle, this) { StringToValue = stringToValue, ValueToString = valueToString });
            var slider_maxBendingAngle = e.AddControl(new MakerSlider(category, "maxBendingAngle", -360f, 360f, DefaultValue.MaxBendingAngle, this) { StringToValue = stringToValue, ValueToString = valueToString });
            var slider_leapSpeed = e.AddControl(new MakerSlider(category, "Tracking Speed", 0f, 50f, DefaultValue.LeapSpeed, this) { StringToValue = stringToValue, ValueToString = valueToString });
            var slider_forntTagDis = e.AddControl(new MakerSlider(category, "forntTagDis", -100f, 100f, DefaultValue.ForntTagDis, this) { StringToValue = stringToValue, ValueToString = valueToString });
            var slider_nearDis = e.AddControl(new MakerSlider(category, "nearDis", -100f, 100f, DefaultValue.NearDis, this) { StringToValue = stringToValue, ValueToString = valueToString });
            var slider_hAngleLimit = e.AddControl(new MakerSlider(category, "Horizontal Tracking Limit", 0f, 360f, DefaultValue.HAngleLimit, this) { StringToValue = stringToValue, ValueToString = valueToString });
            var slider_vAngleLimit = e.AddControl(new MakerSlider(category, "Vertical Tracking Limit", 0f, 360f, DefaultValue.VAngleLimit, this) { StringToValue = stringToValue, ValueToString = valueToString });
